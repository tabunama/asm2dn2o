...
.. csv-table:: DY initial values (columns are AR, AX, DELAY)
   :header: "Simulink index", "State", "Description", "AR", "AX", "DELAY"

   "1", "S_O2", "dissolved oxygen", "4.2", "0.4", "0.4"
   "2", "S_F", "fermentable readily biodegradable substrate", "0.5", "0.01", "0.02"
   "3", "S_A", "acetate / VFA-like soluble carbon", "0.8", "0.1", "0.1"
   "4", "S_I", "soluble inert COD", "30", "30", "20"
   "5", "S_NH4", "ammonium + ammonia nitrogen", "2.7", "2.27", "2.7"
   "6", "S_NH2OH", "hydroxylamine intermediate", "0.066", "0.0577536", "0.01"
   "7", "S_N2O", "dissolved nitrous oxide", "0.005", "0.00335", "0.005"
   "8", "S_NO", "nitric oxide", "0.13", "1.34239", "0.13"
   "9", "S_NO2", "nitrite nitrogen", "0.4", "0.0465717", "0.4"
   "10", "S_NO3", "nitrate nitrogen", "7.9", "7.9", "7.9"
   "11", "S_N2", "dissolved nitrogen gas", "0.3", "2.93247", "0.3"
   "12", "S_PO4", "orthophosphate phosphorus", "2", "0.42098", "2"
   "13", "S_IC", "inorganic carbon", "45", "20", "45"
   "14", "X_I", "particulate inert COD", "500", "400", "450"
   "15", "X_S", "slowly biodegradable particulate substrate", "20", "20", "20"
   "16", "X_H", "ordinary heterotrophic organisms", "550", "650", "600"
   "17", "X_PAO", "phosphate accumulating organisms", "125", "150", "150"
   "18", "X_PP", "polyphosphate storage", "31", "39", "39"
   "19", "X_PHA", "PHA storage polymers", "25", "19", "19"
   "20", "X_AOB", "ammonia oxidizing biomass", "70", "70", "65"
   "21", "X_NOB", "nitrite oxidizing biomass", "50", "40", "40"
   "22", "S_K", "potassium", "10", "11", "10"
   "23", "S_Mg", "magnesium", "14", "12", "14"
   "24", "S_SO4", "sulfate sulfur", "45", "32", "45"
   "25", "S_Fe2", "ferrous iron", "0", "0", "0"
   ...
   "36", "X_HFO_old", "aged HFO pool", "0", "0", "0"
   "37", "X_TSS", "total suspended solids proxy/state", "2200", "2200", "2200"
   "38", "Q_m3d", "volumetric flow", "2191", "2191", "2191"
   "39", "Temp", "liquid temperature", "12.8", "12.7", "12.7"
   "40", "S_Na", "sodium", "90", "70", "90"
   "41", "S_Cl", "chloride", "120", "80", "120"
   "42", "S_Ca", "calcium", "55", "40", "55"
   "43", "AlOH3", "aluminium hydroxide solids", "1.1", "0.5", "1.1"
   "44", "X_ISS0", "inorganic suspended solids pool", "1.2", "1", "1.2"
   "45", "X_CaCO3", "calcium carbonate solids", "2", "1.2", "2"
   "46", "X_CaP", "calcium phosphate solids", "1", "0.5", "1"
   "47", "X_struv", "struvite solids", "0", "0", "0"
   "48", "X_Dummy1", "reserved / unused placeholder", "0", "0", "0"
...
.. csv-table:: 120d initial values (columns are AR, AX, DELAY)
   :header: "Simulink index", "State", "Description", "AR", "AX", "DELAY"

   "1", "S_O2", "dissolved oxygen", "0.3", "0.4", "0.4"
   "2", "S_F", "fermentable readily biodegradable substrate", "0.5", "0.3", "0.02"
   "3", "S_A", "acetate / VFA-like soluble carbon", "0.8", "0.1", "0.1"
   "4", "S_I", "soluble inert COD", "30", "30", "20"
   "5", "S_NH4", "ammonium + ammonia nitrogen", "0.5", "0.4", "0.4"
   "6", "S_NH2OH", "hydroxylamine intermediate", "0.066", "0.0577536", "0.01"
   "7", "S_N2O", "dissolved nitrous oxide", "0.005", "0.00335", "0.005"
   "8", "S_NO", "nitric oxide", "0.13", "1.34239", "0.13"
   "9", "S_NO2", "nitrite nitrogen", "0.4", "0.0465717", "0.4"
   "10", "S_NO3", "nitrate nitrogen", "4.5", "4", "4"
   "11", "S_N2", "dissolved nitrogen gas", "0.3", "2.93247", "0.3"
   "12", "S_PO4", "orthophosphate phosphorus", "2", "0.42098", "2"
   "13", "S_IC", "inorganic carbon", "45", "20", "45"
   "14", "X_I", "particulate inert COD", "600", "550", "500"
   ...
   "18", "X_PP", "polyphosphate storage", "85", "75", "70"
   "19", "X_PHA", "PHA storage polymers", "40", "45", "35"
   "20", "X_AOB", "ammonia oxidizing biomass", "237.208", "85", "80"
   "21", "X_NOB", "nitrite oxidizing biomass", "167.938", "60", "60"
   "22", "S_K", "potassium", "10", "11", "10"
   "23", "S_Mg", "magnesium", "14", "12", "14"
   "24", "S_SO4", "sulfate sulfur", "45", "32", "45"
   "25", "S_Fe2", "ferrous iron", "0", "0", "0"
...
- Keep the initialization file separate from the parameter file. That separation mirrors the
  current Python configuration structure and makes debugging much easier. fileciteturn17file0
